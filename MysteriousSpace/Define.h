...
#define DD_RGB(r, g, b) [UIColor colorWithRed:(r)/255.0 green:(g)/255.0 blue:(b)/255.0 alpha:1.0]
#define DD_RGBA(r, g, b, a) [UIColor colorWithRed:(r)/255.0 green:(g)/255.0 blue:(b)/255.0 alpha:(a)]
...
#define COLOR_BACKGROUND DD_RGB(245, 245, 245)
#define COLOR_LINE DD_RGB(236, 236, 236)
#define COLOR_PLACEHOLDER DD_RGB(179, 179, 179)
